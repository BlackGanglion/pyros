...
function getHttpCmd(projectPath, port) {
    return child_process_1.execSync(projectPath + "/node_modules/http-server/bin/http-server -p " + port, { stdio: "inherit" });
}
function runProject() {
    return __awaiter(this, void 0, void 0, function () {
        var projectPath, pyrosConfigFile, res, _a, projectType, port;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    res = _b.sent();
                    _a = res, projectType = _a.projectType, port = _a.port;
                    switch (projectType) {
                        case "baseReact": {
...
program
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, inquirer.prompt(BASE_INFO_LIST)];
                case 1:
